...
const config = {
  ...
  githubSourceUrl: process.env.GITHUB_SOURCE_URL ?? "https://github.com/MariKiwi/Youtube-AI-Blocker",
  githubReleasesUrl: process.env.GITHUB_RELEASES_URL ?? "https://github.com/MariKiwi/Youtube-AI-Blocker/releases",
