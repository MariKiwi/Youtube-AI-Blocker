...
- Docker config tests also keep the Makefile stack lifecycle commands and Postgres-volume deploy warning path from drifting away from the intended Compose workflow
