...
Purpose:
- Verifies that the root readme and docs index stay friendly to first-time users while still linking the detailed documentation

Coverage:
- The root readme includes website placeholder guidance, first-time user messaging, contribution basics, and key commands
- The docs index links the main detailed documentation files
